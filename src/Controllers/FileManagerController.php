...
namespace Dar3y\FileManager\Controllers;
...
use Dar3y\FileManager\Facades\FileFunctionsFacade;
...
//        dd();
        ...
        return $this->firstViewThatExists('vendor/dar3y/filemanager/index', 'filemanager::index');
    }
    ...
    {
        return $this->firstViewThatExists('vendor/dar3y/filemanager/dialog', 'filemanager::dialog');
    }
    ...
    public function ajaxGetFilesAndFolders(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Response::json($this->firstViewThatExists('vendor/dar3y/filemanager/render', 'filemanager::render', compact('files'))->render());
